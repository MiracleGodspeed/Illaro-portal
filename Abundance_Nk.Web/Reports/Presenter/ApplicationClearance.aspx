<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="ApplicationClearance.aspx.cs" Inherits="Abundance_Nk.Web.Reports.Presenter.ApplicationClearance" %>
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlDepartment" cssclass="form-control" runat="server"></asp:DropDownList>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <asp:Button ID="btnBulkReport" CssClass="btn btn-success mr5" runat="server" Text="Bulk" OnClick="btnBulkReport_Click" />
                                    </div>
                                    <div class="form-group">
