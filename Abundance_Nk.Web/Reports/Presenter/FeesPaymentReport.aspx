        ...
        <ContentTemplate>
            ...
            <div class="form-inline">
                ...
                <div class="form-group">
                    ...
                    <asp:Button ID="Display_Button" runat="server" Text="Display Report" Width="120px" class="btn btn-success " OnClick="Display_Button_Click1" />
                    <asp:Button ID="BulkDownload" runat="server" Text="Bulk Download" Width="120px" class="btn btn-success " OnClick="Bulk_Download" />
                                   <div class="form-group">
