                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-inline">
                                <div class="form-group">
                                    <label  title="Sort Type">Student Type</label>
                                &nbsp;
                                </div>
                                    
                                <div class="form-group" >
                                    <asp:RadioButtonList ID="rbnStudentType" runat="server" RepeatDirection="Horizontal" CssClass="radiobuttonlist3" >
                                        <asp:ListItem Value="1">Main/First Attempt</asp:ListItem> 
                                        <asp:ListItem Value="2">Carry Over</asp:ListItem> 
                                        <asp:ListItem Value="3">Extra Year</asp:ListItem> 
                                        <asp:ListItem Value="4">Alternate</asp:ListItem> 
                                    </asp:RadioButtonList>
                                </div>
                             </div>
