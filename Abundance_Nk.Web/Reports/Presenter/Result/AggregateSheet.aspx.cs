...
{
    public partial class AggregateSheet : System.Web.UI.Page, IReport
    {
        ...
        private void DisplayReportBy(SessionSemester session, Level level, Programme programme, Department department, int type, CourseMode courseMode)
        {
            try
            {
                ...
                AggregateSheetLogic resultLogic = new AggregateSheetLogic();
                ...
                {
                    resultList = resultLogic.GetMaterSheetDetailsByMode(session, level, programme, department);
                }
                ...
                if (resultList != null)
                {
                    ...
                    string fileName = programme.Name.Replace('/', '_') + "_" + level.Name + "_" + department.Name.Replace('/', '_') + "_" + session.Name.Replace('/', '_') + ".pdf";
