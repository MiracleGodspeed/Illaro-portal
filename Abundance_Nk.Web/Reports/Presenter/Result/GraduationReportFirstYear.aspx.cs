...
{
    public partial class GraduationReportFirstYear : System.Web.UI.Page, IReport
    {
        ...
        private void DisplayReportBy(SessionSemester session, Level level, Programme programme, Department department, int type)
        {
            try
            {
                ...
                {
                    resultList = resultLogic.GetGraduationListByOptionFirstYear(session, level, programme, department, DepartmentOption, type);
                }
                else
                {
                    resultList = resultLogic.GetGraduationListFirstYear(session, level, programme, department, type);
                }
        ...
        private void PopulateAllDropDown()
        {
            try
            {
                ...
                Utility.BindDropdownItem(ddlLevel, Utility.GetFirstYearLevels(), Utility.ID, Utility.NAME);
