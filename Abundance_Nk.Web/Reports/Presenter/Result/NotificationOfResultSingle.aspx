<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="NotificationOfResultSingle.aspx.cs" Inherits="Abundance_Nk.Web.Reports.Presenter.Result.NotificationOfResultSingle" %>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlStudent" cssclass="form-control" runat="server" ></asp:DropDownList>
                                    ...
                                    <%--<div class="form-group">
                                        <asp:Button ID="btnBulkDownload" CssClass="btn btn-success mr5" runat="server" Text="Bulk Download" OnClick="btnBulkReport_Click" />
                                    </div>--%>
                                    <div class="form-group">
