<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="MasterSheet.aspx.cs" Inherits="Abundance_Nk.Web.Reports.Presenter.Result.MasterSheet" %>
...
<body style="border:none; margin:0; padding:0">
    <form id="form1" runat="server">
     <div>
         <asp:ScriptManager ID="ScriptManager1" runat="server" AsyncPostBackTimeOut="70000">
         </asp:ScriptManager>
