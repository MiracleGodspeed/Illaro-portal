                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <div><b>Previous School:</b></div>
                                    <div class="row;form-control">
                                        <asp:RadioButton ID="rbnFEDPOLYILARO" runat="server" AutoPostBack="False" GroupName="Selector" Text=" FEDERAL POLY ILARO" />
                                    </div>
                                    <div class="row;form-control">
                                        <asp:RadioButton ID="rbnOTHERS" runat="server" AutoPostBack="False" GroupName="Selector" Text=" ANY" />
                                    </div>
                                </div>
