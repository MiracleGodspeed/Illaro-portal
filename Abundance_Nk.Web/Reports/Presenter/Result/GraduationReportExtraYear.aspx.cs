...
{
    public partial class GraduationReportExtraYear : System.Web.UI.Page, IReport
    {
        ...
        private void DisplayReportBy(SessionSemester session, Level level, Programme programme, Department department, int type)
        {
            try
            {
                ...
                {
                    resultList = resultLogic.GetGraduationListByOptionExtraYear(session, level, programme, department, DepartmentOption, type);
                }
                else
                {
                    resultList = resultLogic.GetGraduationListExtraYear(session, level, programme, department, type);
                }
